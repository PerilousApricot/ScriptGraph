...
data_era = "B" # or "A" or "B"
if data_era == "AplusB":
    import genTree2011SummerAplusB as genTree
elif data_era == "A":
    import genTree2011SummerA as genTree
elif data_era == "B":
    import genTree2011SummerB as genTree
...
baseWorkDir = "/uscms_data/d3/meloam/2011-october%s" % data_era
...
webRoot   = "/afs/fnal.gov/files/home/room3/meloam/public_html/s8/2011-october-B/%s" % binName
#webRoot  = "/scratch/meloam/btag/2011-mayplot/"
#webRoot  = "/uscms_data/d2/meloam/input39x2/edges/plots/"
httpRoot = "http://home.fnal.gov/~meloam/s8/2011-october-B/%s" % binName
