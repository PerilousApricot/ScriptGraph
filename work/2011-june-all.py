...
import genTree2011two as genTree
...
baseWorkDir = "/uscms_data/d3/meloam/2011-june"
...
jet_bins = [
        ...
        [ "120to130","120..130","115","135"],
        [ "130to140","130..140","125","145"],
        [ "140to", "140..", "135", "210"]
]
...
dataTriggerMiter.add( trigger_map['hltdijet110'], bin="120..130" )

dataTriggerMiter.add( trigger_map['hltdijet110'], bin="130..140" )

dataTriggerMiter.add( trigger_map['hltdijet110'], bin="140.." )
...
for (onedata, onemc) in haddedDataFinalSystMiter.zip( haddedMCFinalSystMiter ):
    ...
    runs8edge = LocalScriptEdge(
                        name = "s8solver-closure-%s-%s-pasbin2" % (syst,opoint) , 
...
if not simple_mode:
    ...
    for opoint in operating_points:
        combinedMiter.add(makeTableHelper( g, reference = closureSolver.getOneValue( syst = 'nominal', opoint = opoint ),
                            ...
                            systname  = "syst.txt",
                            outlatex  = "latex.txt",
                            step_postfix = "%s-%s-pasbin2" % (opoint, 'gsplit')),
                        opoint = opoint,
                        syst = 'gsplit')
    ...
    for opoint in operating_points:
        combinedMiter.add(makeTableHelper( g, reference = normalSolver.getOneValue( syst = 'nominal', opoint = opoint ),
                            ...
                            systname  = "syst.txt",
                            outlatex  = "latex.txt",
                            step_postfix = "%s-%s-pasbin2" % (opoint, 'mu')
                            ),
                        opoint = opoint,
                        syst = 'mu')
    ...
    for opoint in operating_points:
        combinedMiter.add(makeTableHelper( g, reference = normalSolver.getOneValue( syst = 'nominal', opoint = opoint ),
                            ...
                            systname  = "syst.txt",
                            outlatex  = "latex.txt",
                            step_postfix = "%s-%s-pasbin2" % (opoint, 'awaytag')),
                        opoint = opoint,
                        syst = 'awaytag')
    ...
    for opoint in operating_points:
        combinedMiter.add(makeTableHelper( g, reference = closureSolver.getOneValue( syst = 'nominal', opoint = opoint ),
                            ...
                            systname  = "syst.txt",
                            outlatex  = "latex.txt",
                            step_postfix = "%s-%s-pasbin2" % (opoint, 'closure')),
                        opoint = opoint,
                        syst = 'closure')
    ...
    for opoint in operating_points:
        combinedMiter.add(makeTableHelper( g, reference = normalSolver.getOneValue( syst = 'nominal', opoint = opoint ),
                            ...
                            systname  = "syst.txt",
                            outlatex  = "latex.txt",
                            step_postfix = "%s-%s-pasbin2" % (opoint, 'ptrel')),
                        opoint = opoint,
                        syst = 'ptrel')
    ...
    for opoint in operating_points:
        combinedMiter.add(makeTableHelper( g, reference = normalSolver.getOneValue( syst = 'nominal', opoint = opoint ),
                            ...
                            systname  = "syst.txt",
                            outlatex  = "latex.txt",
                            step_postfix = "%s-%s-pasbin2" % (opoint, 'ttbar')),
                        opoint = opoint,
                        syst = 'ttbar')
