...
for opoint in operating_points:
    for bin in jet_bins:  
        currNode = hadd_helper( g, "-%s-%s-data-highpt-30" % (bin[0],opoint), 
...
#
allPages = Miter()
webRoot  = "/afs/fnal.gov/files/home/room3/meloam/public_html/s8/highpt-with-30/"
httpRoot = "http://home.fnal.gov/~meloam/s8/highpt-with-30/"
...
output += "<p>MC is cut on the HLT_BTagMu_DiJet10U trigger, Data is Jet10U+Jet20U+DiJet30U</p><hr />"
